                                    ...
                                    Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: <Widget>[
                                            ...
                                            Text(
                                              '${currencySymbol()} ${numberFormat.format(int.tryParse(widget.product!.price!)! * selectedQty)}',
                                              style: const TextStyle(
                                                  color: Color(0xff5956E9),
                                                  fontSize: 22,
                                                  fontWeight: FontWeight.w700,
          ...
          child: FlutterCarousel(
            ...
            options: CarouselOptions(
                ...
                slideIndicator: CircularSlideIndicator(
                    indicatorRadius: 3,
                    itemSpacing: 10,
                    indicatorBackgroundColor: const Color.fromRGBO(0, 0, 0, 1),
                    currentIndicatorColor: Colors.blue[900]),
